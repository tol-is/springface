...
export default function App(): React.ReactElement {
  const {
    ...
    Shadow: folder({
      ...
      grayscale: false,
      shadowMode: { value: 'pointer', options: ['pointer', 'angle'] as const },
      shadowAngleDeg: { value: 45, min: 0, max: 360, step: 1 },
    }),
    Width: folder({
    ...
    Spring: folder({
      maxDistancePx: { value: 200, min: 100, max: 300, step: 1 },
  ...
  const shadowAngle = shadowMode === 'angle' ? shadowAngleDeg : null;
